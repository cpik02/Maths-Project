...
public class ProgrammingAssignment {
    ...
    public static void degree1OutputDescription (double c) throws Exception {
            String code;
            if ((c > 1)||(c < -1)) //Determine whether the graph is increasing or not
                code = "1";
            else
                code = "0";
            if ((c < 1)&&(c > -1)&&(c != 0)) //Determine whether the graph is decreasing or not
                code = code.concat("1");
            else
                code = code.concat("0");
            ...
            if (c < 0) //Determine whether the graph is up-down or not
                ...
                code = code.concat("0");
            if ((c > 1)||(c < -1)) //Determine whether the graph is diverging or not
                code = code.concat("1");
            else
                code = code.concat("0");
            if ((c < 0)&&(c >= -1)) //Determine whether the graph is converging or not
                code = code.concat("1");
            else
                code = code.concat("0");
    ...
    public static void degree2OutputDescription (double c1, double c2) throws Exception {
            String code;
            if (((c1>0.5)&&(c2>0.5))||(c2<-1)||((c1<0)&&(c2>0))||
                ((c1<-1)&&!((c2==-1)||((c2>-1)&&(c2<0))))) 
                //Determine whether the graph is increasing or not
                code = "1";
            else
                code = "0";
            if (!(((c1 == 0)&&(c2 == 0))||((c1 == 0.5)&&(c2 == 0.5))||
                (c2 == -1))&&!(((c1>0.5)&&(c2>0.5))||(c2<-1)||((c1<0)&&
                (c2>0))||((c1<-1)&&!((c2==-1)||((c2>-1)&&(c2<0)))))) 
                //Determine whether the graph is decreasing or not
                code = code.concat("1");
            else
                code = code.concat("0");
            if (((c1 == 0)&&(c2 == 0))||((c1 == 0.5)&&(c2 == 0.5))||(c2 == -1)) 
                //Determine whether the graph is constant or not
                code = code.concat("1");
            else
                code = code.concat("0");
            if ((c1 < 0)||(c2 < 0)) //Determine whether the graph is up-down or not
                code = code.concat("1");
            else
                code = code.concat("0");
            if (((c1>0.5)&&(c2>0.5))||(c2<-1)||((c1<0)&&(c2>0))||
                ((c1<-1)&&!((c2==-1)||((c2>-1)&&(c2<0))))) 
                //Determine whether the graph is diverging or not
                code = code.concat("1");
            else
                code = code.concat("0");
            if (!(((c1 == 0)&&(c2 == 0))||((c1 == 0.5)&&(c2 == 0.5))||
                (c2 == -1))&&!(((c1>0.5)&&(c2>0.5))||(c2<-1)||((c1<0)&&
                (c2>0))||((c1<-1)&&!((c2==-1)||((c2>-1)&&(c2<0)))))) 
                //Determine whether the graph is converging or not
                code = code.concat("1");
            else
                code = code.concat("0");
            displayOutputDescription(code);
